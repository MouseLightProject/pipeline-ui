    ...
    public render() {
        return (
            <div>
                ...
                <p>
                    You can also change a repository to point to a different location that contains scripts with
                    the same names, but have different implementations.  In that way you could allow existing pipeline
                    stages to run variations of their tasks without changing each stage or task
                    directly.
                </p>
                <p>
